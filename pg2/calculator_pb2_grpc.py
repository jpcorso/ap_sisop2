...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Multiply = channel.unary_unary(
                ...
                _registered_method=True)
        self.ReturnBigger = channel.unary_unary(
                '/Calculator/ReturnBigger',
                request_serializer=calculator__pb2.ReturnBiggerRequest.SerializeToString,
                response_deserializer=calculator__pb2.ReturnBiggerReply.FromString,
                _registered_method=True)
        self.Quotient = channel.unary_unary(
                '/Calculator/Quotient',
                request_serializer=calculator__pb2.QuotientRequest.SerializeToString,
                response_deserializer=calculator__pb2.QuotientReply.FromString,
                _registered_method=True)
...
class CalculatorServicer(object):
    ...
    def ReturnBigger(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ReturnBigger': grpc.unary_unary_rpc_method_handler(
                    servicer.ReturnBigger,
                    request_deserializer=calculator__pb2.ReturnBiggerRequest.FromString,
                    response_serializer=calculator__pb2.ReturnBiggerReply.SerializeToString,
            ),
            'Quotient': grpc.unary_unary_rpc_method_handler(
                    servicer.Quotient,
                    request_deserializer=calculator__pb2.QuotientRequest.FromString,
                    response_serializer=calculator__pb2.QuotientReply.SerializeToString,
            ),
    }
...
class Calculator(object):
    ...
    def ReturnBigger(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Calculator/ReturnBigger',
            calculator__pb2.ReturnBiggerRequest.SerializeToString,
            calculator__pb2.ReturnBiggerReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Quotient(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Calculator/Quotient',
            calculator__pb2.QuotientRequest.SerializeToString,
            calculator__pb2.QuotientReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
